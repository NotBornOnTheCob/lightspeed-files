[function(require, module, exports) {
    ...
    function drainQueue() {
        if (!draining) {
            ...
            currentQueue = null, draining = false,
                function(marker) {
    ...
    }, process.title = "browser", process.browser = true, process.env = {}, process.argv = [], process.version = "", process.versions = {}, process.on = noop, process.addListener = noop, process.once = noop, process.off = noop, process.removeListener = noop, process.removeAllListeners = noop, process.emit = noop, process.prependListener = noop, process.prependOnceListener = noop, process.listeners = function(name) {
        return []
